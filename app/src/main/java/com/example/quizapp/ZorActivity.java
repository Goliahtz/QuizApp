...
public class ZorActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Questions
        final String[] arrayQ = {getString(R.string.z1), getString(R.string.z2)
                , getString(R.string.z3), getString(R.string.z4),
                getString(R.string.z5), getString(R.string.z6), getString(R.string.z7),
                getString(R.string.z8), getString(R.string.z9), getString(R.string.z10)};
