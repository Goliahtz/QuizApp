...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        b_kolay.setText(""+dataHelper.receiveDataInt("En İyi Zor",0));
    ...
    public void alertDialog(){
        View view = LayoutInflater.from(MainActivity.this).inflate(R.layout.uyaripenceresi,null,false);
        ...
        builder.setMessage("Kullanıcı Adınızı Giriniz")
                ...
                .setPositiveButton("Kaydet", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        dataHelper.saveDataString("İsim",a);
